...
public class MenuPrincipalSFX : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (ManagerDeMúsica.Instance != null)
            ManagerDeMúsica.Instance.PlayMusic("MAIN MENU");
    }
    ...
    // --- Funciones de Actualización (Conéctalas al OnValueChanged de cada Slider) ---

    public void UpdateMasterVolume(float volume)
    {
        // "MasterVolume" debe ser el nombre del parámetro expuesto en el AudioMixer
